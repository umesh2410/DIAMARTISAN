    ...
    <main>
        <section class="products">
            <div class="product" data-id="1" data-name="Diamond Drop Earrings" data-price="3000">
                <img src="image/necklace2.png" alt="Diamond Drop Earrings" style="margin-top: -3.3vh;">
                <h2>Diamond Drop Earrings</h2>
                <p>Price: ₹3000</p>
                <button class="add-to-cart">Add to Cart</button><br>
                <a href="tryon.html" class="TryOn">Try On</a>
            </div>
            <div class="product" data-id="2" data-name="Gold Hoop Earrings" data-price="2500">
                <img src="image/necklace.png" alt="Gold Hoop Earrings">
                <h2 style="margin-top: 2vh; margin-left: 2vh; margin-right: 2vh;">Gold Hoop Earrings</h2>
                <p>Price: ₹2500</p>
                <button class="add-to-cart">Add to Cart</button><br>
                <a href="tryon2.html" class="TryOn">Try On</a>
            </div>
            <div class="product" data-id="3" data-name="Gold Hoop Earrings" data-price="2500">
                <img src="image/necklace_4.jpg" alt="Gold Hoop Earrings">
                <h2 style="margin-top: 2vh; margin-left: 2vh; margin-right: 2vh;">Gold Hoop Earrings</h2>
                <p>Price: ₹2500</p>
                <button class="add-to-cart">Add to Cart</button><br>
                <a href="tryon3.html" class="TryOn">Try On</a>
            </div>
            <div class="product" data-id="4" data-name="Gold Hoop Earrings" data-price="2500">
                <img src="image/necklace_2.jpeg" alt="Gold Hoop Earrings">
                <h2 style="margin-top: 2vh; margin-left: 2vh; margin-right: 2vh;">Gold Hoop Earrings</h2>
                <p>Price: ₹2500</p>
                <button class="add-to-cart">Add to Cart</button><br>
                <a href="tryon4.html" class="TryOn">Try On</a>
            </div>
