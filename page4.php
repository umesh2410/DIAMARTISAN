    ...
    <main>
        <section class="products">
            <div class="product" data-id="1" data-name="Diamond Drop Earrings" data-price="3000">
                <img src="image/bracelet-tryon.png" alt="Diamond Drop Earrings" style="margin-top: -5vh; margin-bottom: -5vh;">
                <h2>Diamond Drop Earrings</h2>
                <p>Price: ₹3000</p>
                <button class="add-to-cart">Add to Cart</button><br>
                <a href="tryonbrace.html" class="TryOn">Try On</a>
            </div>
            <div class="product" data-id="2" data-name="Diamond Drop Earrings" data-price="3000">
                <img src="image/brace1.png" alt="Diamond Drop Earrings"  style="margin-top: -5vh; margin-bottom: -5vh;">
                <h2>Diamond Drop Earrings</h2>
                <p>Price: ₹3000</p>
                <button class="add-to-cart">Add to Cart</button><br>
                <a href="tryonbrace1.html" class="TryOn">Try On</a>
            </div>
            <div class="product" data-id="3" data-name="Diamond Drop Earrings" data-price="3000">
                <img src="image/bracelet-tryon.png" alt="Diamond Drop Earrings" style="margin-top: -5vh; margin-bottom: -5vh;">
                <h2>Diamond Drop Earrings</h2>
                <p>Price: ₹3000</p>
                <button class="add-to-cart">Add to Cart</button><br>
            ...
            <div class="product" data-id="4" data-name="Diamond Drop Earrings" data-price="3000">
                <img src="image/bracelet-tryon.png" alt="Diamond Drop Earrings" style="margin-top: -5vh; margin-bottom: -5vh;">
                <h2>Diamond Drop Earrings</h2>
                <p>Price: ₹3000</p>
                <button class="add-to-cart">Add to Cart</button><br>
                <a href="tryonbrace.html" class="TryOn">Try On</a>
            <!-- </div>
            <div class="product" data-id="5" data-name="Diamond Drop Earrings" data-price="3000">
                <img src="image/bracelet-tryon.png" alt="Diamond Drop Earrings" style="margin-top: -5vh; margin-bottom: -5vh;">
                <h2>Diamond Drop Earrings</h2>
                <p>Price: ₹3000</p>
                <button class="add-to-cart">Add to Cart</button><br>
